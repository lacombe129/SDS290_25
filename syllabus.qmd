...
-   Scott LaCombe (`slacombe@smith.edu`).Wright Hall 201. My hours will be held on Wednesdays from 9:00-10:00 AM and 3-4 PM (sign up slots are [here](https://calendar.google.com/calendar/u/0/appointments/schedules/AcZssZ2dZutkpVxNhPQQugcl-KAy8RTmiTzTmaNfIkzN1jT2s9oOQcDE8Ivcn-QpOqq2f2GQdYuHcrrr)), and I have open hours from 9:30-11:00 on Fridays, no appointment needed. 
...
The US of generative AI to produce any written work in this classroom is **forbidden** and will be considered an honor board violation unless explicitly stated otherwise. Submissions using AI will be given a 0 and submitted to the Academic Honor Board. That being said, AI can be consulted to develop code for assignments, but you must include a statement acknowledging the use of the program and all final code must be yours and yours alone.  
