...
-   Scott LaCombe (`slacombe@smith.edu`). Wright Hall 201
-   Office Hours: Wednesdays from 9:00-10:00 AM and 3-4 PM (sign up slots are [here](https://calendar.google.com/calendar/u/0/appointments/schedules/AcZssZ2dZutkpVxNhPQQugcl-KAy8RTmiTzTmaNfIkzN1jT2s9oOQcDE8Ivcn-QpOqq2f2GQdYuHcrrr)), open hours are from 9:30-11:00 on Fridays, no appointment needed. 
...
AI can be a powerful tool to help us understand the world and quickly identify information. However, it comes at a real cost of potentially outsourcing our critical thinking skills and building a foundation for understanding core concepts. Therefore, use of generative AI is **prohibited** for any writing assignment, homework or exam. This work must be your own. However, there are cases where use of AI may be appropriate for the class, and I will explicitly note if you can use it for tasks like developing stimuli for your survey experiments. Unless explicitly stated in an assignment that you may use it, all other use of generative AI is **not permitted** in this course and suspected violations of this course policy will be reported to the Academic Honor Board for potential Honor Code violations. 
...
3.  **Exams** \[30%\]: There will be two exams throughout the term. See the course schedule for tentative dates of these exams. They will be given through the Science Center's self-scheduled exams. 
...
`Percent of Total` <- c("30%", "10%", "30%", "10%", "20%", "100%")
`Due Date` <- c("Fridays", "Daily", "March 7-9th and April 25-27th", "March 28", "May 8", "")
...
Percent <- c("93-100%", "90-92.5%", "87-89%",	"83-86%",	"80-82%", "77-79%", "73-76%", "70-72%", "60-66%", "67-69%", "59% and below")
...
Please refer to the complete [day-to-day schedule](https://docs.google.com/spreadsheets/d/131eOI-EH2uypTRMhCbW6aT2lEGNJbUA2T7GS2MAHOOA/edit?usp=sharing) for more detailed information.
